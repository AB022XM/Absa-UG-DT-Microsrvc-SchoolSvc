...
To build the final jar and optimize the AbsaUGDTMicrosrvcSchoolSvc application for production, run:
...
Then navigate to [http://localhost:9055](http://localhost:9055) in your browser.
